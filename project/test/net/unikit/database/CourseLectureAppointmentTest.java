...
public class CourseLectureAppointmentTest extends AbstractTest<CourseLectureAppointment, Integer, CourseLectureAppointment.ID, CourseLectureAppointmentManager> {
    ...
    protected void init() throws Exception {
        ...
        evm_1.put("startDate", toDate("2015-10-25 08:15:00"));
        evm_1.put("endDate", toDate("2015-10-25 11:30:00"));
        evm_1.makeImmutable();

        // Create entity value map for the second entity
        evm_2 = createEntityValueMap();
        evm_2.put("id", manager.createID(2));
        evm_2.put("courseLecture", DatabaseTestUtils.getEntity(CourseLecture.class, 1));
        evm_2.put("startDate", toDate("2015-11-15 08:15:00"));
        evm_2.put("endDate", toDate("2015-11-15 11:30:00"));
        evm_2.makeImmutable();
    }
