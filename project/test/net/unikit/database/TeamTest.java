...
/**
 * Unit tests for Team and TeamManager.
 */
public class TeamTest extends AbstractTest<Team, Integer, Team.ID, TeamManager> {
    private static final int DEFAULT_ENTITY_COUNT = 12;
     ...
     */
    @Override
    protected Class<Team> getInterfaceClass() {
        return Team.class;
    }

    /**
     * Initialize all Team specific attributes
    ...
    /**
     * Tests the method getAllEntities of the TeamManager.
    ...
    public void test_getAllEntities() throws EntityNotFoundException {
        ...
        for (Team entity1 : allEntities) {
            Team entity2 = manager.getEntity(entity1.getId());
    ...
    public void test_getEntity() throws EntityNotFoundException {
        ...
        Team entity_1 = manager.getEntity(manager.createID(1));
        checkValuesEquals(evm_1, getEntityValueMap(entity_1));

        // Check values of the second entity
        Team entity_2 = manager.getEntity(manager.createID(2));
        checkValuesEquals(evm_2, getEntityValueMap(entity_2));
    }
