...
/**
 * Unit tests for MembershipRequest and MembershipRequestManager.
 */
public class MembershipRequestTest extends AbstractTest<MembershipRequest, Integer, MembershipRequest.ID, MembershipRequestManager> {
    ...
    /**
     * Initialize all MembershipRequest specific attributes
    ...
    /**
     * Tests the method getAllEntities of the MembershipRequestManager.
    ...
    public void test_getAllEntities() throws EntityNotFoundException {
        ...
        for (MembershipRequest entity1 : allEntities) {
            MembershipRequest entity2 = manager.getEntity(entity1.getId());
